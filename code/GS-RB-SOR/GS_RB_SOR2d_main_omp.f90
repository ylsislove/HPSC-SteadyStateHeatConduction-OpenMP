...
! GS_RB_SOR2d_main_omp.f90

program GS_RB_SOR2d_main
    implicit none
    ...
    write (*,"('Solving Laplace equation on',i4,' by',i4,' grid by GS-RB-SOR iteration')") n,n
    ! i4 - 4 characters wide
    ! print "('Solving Laplace equation on',i4,' by',i4,' grid by GS_RB_SOR iteration')", n,n
    ...
    ! nthreads = 1
    ! call GS_RB_SOR2d_sub(n, tol, maxiter, iter, dumax, nthreads)

    nthreads = 2
    call GS_RB_SOR2d_sub(n, tol, maxiter, iter, dumax, nthreads)


end program GS_RB_SOR2d_main
